...
<div class="wrapper">
    ...
    <!--form start-->
    <form name="form" method="POST" action="thankyou.php" OnSubmit="return fncValidate();" autocomplete="off" >
    ...
    <option value="p">Missing/Found Person</option>
    <option value="v">Missing/Found Vehicles</option>
    <option value="g">Genarel Crime</option>
    <option value="i">Lost Items</option>
