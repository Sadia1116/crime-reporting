...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 27, 2021 at 07:47 PM
...
INSERT INTO `report` (`rid`, `fname`, `lname`, `gender`, `ctype`, `address`, `phone`, `email`, `nid`, `com`) VALUES
(1, 'abc', 'efg', 'male', 'Missing/Found Vehicles', 'dhaka', 1234567891, 'a@gmail.com', 123, 'car nameplate:1111 that is missing'),
(2, 'afhgf', 'nvhf', 'male', 'Missing/Found Person', 'dhaka', 1119876, 'k@gmail.com', 6543, 'age : 22 , gender: female,Name:Ruma . she is missing '),
(3, 'Rafa', 'Islam', 'Male', 'Genarel Crime', 'Basabo,Dhaka', 1234567890, 'rafa@gmail.com', 654321, 'hijeck'),
(4, 'Tasrif', 'Islam', 'Male', 'Genarel Crime', 'Basabo,Dhaka', 1434567891, 't@gmail.com', 55666, 'Looting'),
(5, 'Raka', 'Tiasa', 'Female', 'Genarel Crime', 'Basabo,Dhaka', 1434567891, 't@gmail.com', 55666, 'Looting'),
(6, 'Rafid', 'Akondo', 'Male', 'Others', 'Rampura,Dhaka', 1987654311, 'rafid@gmail.com', 33333, 'accident');
...
--
ALTER TABLE `report`
  MODIFY `rid` int(254) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
